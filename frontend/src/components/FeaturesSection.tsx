...
const FeaturesSection = () => {
  ...
  const localizedFeatures = [
    { ...features[0], title: tr("aiCropRecommendation", lang), desc: tr("aiCropRecommendationDesc", lang) },
    { ...features[1], title: tr("climateAwareInsights", lang), desc: tr("climateAwareInsightsDesc", lang) },
    { ...features[2], title: tr("farmerFriendlyInterface", lang), desc: tr("farmerFriendlyInterfaceDesc", lang) },
  ];
  return (
